...
static void vGPIO_SD_Init(hal_sd_blk_dev_handle_t xSDHandle);
...
static hal_sd_blk_dev_handle_t xSDHandle;

/* Holds parameters for the detected SD card. */
static hal_sd_card_info_t xSDCardInfo;
